...
void QOP_F2_asqtad_force_multi_fnmat(QOP_info_t *info, QOP_F2_GaugeField *gauge,
				      QOP_F2_Force *force, QOP_asqtad_coeffs_t *coef,
				      QOP_F_Real eps[], QDP_F2_ColorVector *x[], int nterms);
...
void 
QOP_F2_hisq_deriv_multi_wrapper_fnmat2(QOP_info_t *info,  
					QOP_F2_FermionLinksHisq *flh,
					QOP_F2_Force *Force, 
					QOP_hisq_coeffs_t *hisq_coeff,
					QOP_F_Real *epsv,
...
void 
QOP_F2_hisq_force_multi_wrapper_fnmat2(QOP_info_t *info,  
					QOP_F2_FermionLinksHisq *flh,
					QOP_F2_Force *Force, 
					QOP_hisq_coeffs_t *hisq_coeff,
					QOP_F_Real *epsv,

...
QOP_D3_ColorVector  *QOP_D3_create_V_from_raw( QDP_Lattice *lat, QOP_D_Real *src, QOP_evenodd_t evenodd);
QOP_D3_DiracFermion *QOP_D3_create_D_from_raw( QDP_Lattice *lat, QOP_D_Real *src, QOP_evenodd_t evenodd);
QOP_D3_GaugeField   *QOP_D3_create_G_from_raw( QDP_Lattice *lat, QOP_D_Real *links[], QOP_evenodd_t evenodd);
QOP_D3_Force        *QOP_D3_create_F_from_raw( QDP_Lattice *lat, QOP_D_Real *force[], QOP_evenodd_t evenodd);

/* copy QOP field into a raw field */
void QOP_D3_extract_V_to_raw(QDP_Lattice *lat, QOP_D_Real *dest, QOP_D3_ColorVector *src, QOP_evenodd_t evenodd);
void QOP_D3_extract_D_to_raw(QDP_Lattice *lat, QOP_D_Real *dest, QOP_D3_DiracFermion *src, QOP_evenodd_t evenodd);
void QOP_D3_extract_G_to_raw(QDP_Lattice *lat, QOP_D_Real *dest[], QOP_D3_GaugeField *src, QOP_evenodd_t evenodd);
void QOP_D3_extract_F_to_raw(QDP_Lattice *lat, QOP_D_Real *dest[], QOP_D3_Force *src, QOP_evenodd_t evenodd);
...
QOP_D3_ColorVector  *QOP_D3_convert_V_from_raw( QDP_Lattice *lat, QOP_D_Real *src, QOP_evenodd_t evenodd);
QOP_D3_DiracFermion *QOP_D3_convert_D_from_raw( QDP_Lattice *lat, QOP_D_Real *src, QOP_evenodd_t evenodd);
QOP_D3_GaugeField   *QOP_D3_convert_G_from_raw( QDP_Lattice *lat, QOP_D_Real *links[], QOP_evenodd_t evenodd);
QOP_D3_Force        *QOP_D3_convert_F_from_raw( QDP_Lattice *lat, QOP_D_Real *force[], QOP_evenodd_t evenodd);

/* create a raw field from the data in the QOP field and destroy it */
/* if the QOP field was created with a convert from raw function then
   this will return the same raw source used as input */
QOP_D_Real  *QOP_D3_convert_V_to_raw(QDP_Lattice *lat, QOP_D3_ColorVector *src, QOP_evenodd_t evenodd);
QOP_D_Real  *QOP_D3_convert_D_to_raw(QDP_Lattice *lat, QOP_D3_DiracFermion *src, QOP_evenodd_t evenodd);
QOP_D_Real **QOP_D3_convert_G_to_raw(QDP_Lattice *lat, QOP_D3_GaugeField *src, QOP_evenodd_t evenodd);
QOP_D_Real **QOP_D3_convert_F_to_raw(QDP_Lattice *lat, QOP_D3_Force *src, QOP_evenodd_t evenodd);
...
QOP_D3_FermionLinksAsqtad *
  QOP_D3_asqtad_create_L_from_raw( QDP_Lattice *lat, 
                                  QOP_D_Real *fatlinks[],
...
QOP_D3_FermionLinksWilson *
  QOP_D3_wilson_create_L_from_raw( QDP_Lattice *lat, 
...
QOP_D3_FermionLinksDW *
  QOP_D3_dw_create_L_from_raw( QDP_Lattice *lat, 
                              QOP_D_Real *links[],
			      QOP_evenodd_t evenodd);

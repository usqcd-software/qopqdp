...
QOP_PC_ColorVector  *QOP_PC_create_V_from_raw(QOP_P_Real *src, QOP_evenodd_t evenodd);
QOP_PC_DiracFermion *QOP_PC_create_D_from_raw(QOP_P_Real *src, QOP_evenodd_t evenodd);
QOP_PC_GaugeField   *QOP_PC_create_G_from_raw(QOP_P_Real *links[], QOP_evenodd_t evenodd);
QOP_PC_Force        *QOP_PC_create_F_from_raw(QOP_P_Real *force[], QOP_evenodd_t evenodd);
...
QOP_PC_ColorVector  *QOP_PC_convert_V_from_raw(QOP_P_Real *src, QOP_evenodd_t evenodd);
QOP_PC_DiracFermion *QOP_PC_convert_D_from_raw(QOP_P_Real *src, QOP_evenodd_t evenodd);
QOP_PC_GaugeField   *QOP_PC_convert_G_from_raw(QOP_P_Real *links[], QOP_evenodd_t evenodd);
QOP_PC_Force        *QOP_PC_convert_F_from_raw(QOP_P_Real *force[], QOP_evenodd_t evenodd);
...
void QOP_PC_symanzik_1loop_gauge_deriv(QOP_info_t *info, 
				       QOP_PC_GaugeField *gauge, 
				       QOP_PC_Force *force,
				       QOP_gauge_coeffs_t *coeffs,
				       QOP_P_Real eps);
...
QOP_PC_FermionLinksAsqtad *
  QOP_PC_asqtad_create_L_from_raw(QOP_P_Real *fatlinks[], QOP_P_Real *longlinks[],
...
void QOP_PC_asqtad_extract_L_to_raw(QOP_P_Real *fatlinks[], QOP_P_Real *longlinks[],
...
QOP_PC_FermionLinksAsqtad *
  QOP_PC_asqtad_convert_L_from_raw(QOP_P_Real *fatlinks[], QOP_P_Real *longlinks[],
				   QOP_evenodd_t evenodd);

void QOP_PC_asqtad_convert_L_to_raw(QOP_P_Real ***fatlinks, QOP_P_Real ***longlinks,
				    QOP_PC_FermionLinksAsqtad *,
				    QOP_evenodd_t evenodd);

void QOP_PC_asqtad_load_L_from_raw(QOP_PC_FermionLinksAsqtad *asqtad,
				   QOP_P_Real *fatlinks[], QOP_P_Real *longlinks[],
				   QOP_evenodd_t evenodd);
...
QOP_PC_FermionLinksWilson *
  QOP_PC_wilson_create_L_from_raw(QOP_P_Real *links[], QOP_P_Real *clov,
				  QOP_evenodd_t evenodd);
...
QOP_PC_FermionLinksWilson *
  QOP_PC_wilson_convert_L_from_raw(QOP_P_Real *links[], QOP_P_Real *clov,
				   QOP_evenodd_t evenodd);
...
QOP_PC_FermionLinksDW *
  QOP_PC_dw_create_L_from_raw(QOP_P_Real *links[], QOP_evenodd_t evenodd);
...
QOP_PC_FermionLinksDW *
  QOP_PC_dw_convert_L_from_raw(QOP_P_Real *links[], QOP_evenodd_t evenodd);

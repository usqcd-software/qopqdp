...
void QOP_PC_extract_V_to_raw(QDP_Lattice *lat, QOP_P_Real *dest, QOP_PC_ColorVector *src, QOP_evenodd_t evenodd);
void QOP_PC_extract_D_to_raw(QDP_Lattice *lat, QOP_P_Real *dest, QOP_PC_DiracFermion *src, QOP_evenodd_t evenodd);
void QOP_PC_extract_G_to_raw(QDP_Lattice *lat, QOP_P_Real *dest[], QOP_PC_GaugeField *src, QOP_evenodd_t evenodd);
void QOP_PC_extract_F_to_raw(QDP_Lattice *lat, QOP_P_Real *dest[], QOP_PC_Force *src, QOP_evenodd_t evenodd);
...
void QOP_PC_asqtad_ddagd(QOP_info_t *info,
			 QOP_PC_FermionLinksAsqtad *asqtad,
			 QOP_P_Real mass,
...
QOP_P_Real QOP_PC_asqtad_ddagd_norm2(QOP_info_t *info,
				     QOP_PC_FermionLinksAsqtad *asqtad,
				     QOP_P_Real mass,
				     QDP_PC_ColorVector *out,
				     QDP_PC_ColorVector *in,
...
void QOP_PC_asqtad_solve_multi_qdp(QOP_info_t *info,
				   QOP_PC_FermionLinksAsqtad *fla,
...
void QOP_C_wilsonMgSetup(QOP_C_WilsonMg *wmg);
#endif // _QOP_C_MG

void QOP_PC_wilsonMgSetLinks(QOP_C_WilsonMg *wmg, QOP_PC_FermionLinksWilson *wil);
void QOP_PC_wilsonMgSolve(QOP_info_t *info, QOP_C_WilsonMg *wmg,
			  QOP_PC_FermionLinksWilson *flw,

...
/* for QCDOC: re/im, row,column and:
   QOP_*_ColorVector : x(fastest)yzt, even first
   QOP_*_DiracFermion: ???
   QOP_*_GaugeField  : x(fastest)yzt, even first, dir(xyzt)
   QOP_*_Force       : x(fastest)yzt, even first, dir(xyzt)
*/
...
QOP_F3_FermionLinksAsqtad *
  QOP_F3_asqtad_create_L_from_G(QOP_asqtad_coeffs_t *coeffs,
...
QOP_D3_FermionLinksAsqtad *
  QOP_D3_asqtad_create_L_from_raw(double *fatlinks[], double *longlinks[],
				  QOP_evenodd_t evenodd);
QOP_D3_FermionLinksAsqtad *
  QOP_D3_asqtad_create_L_from_G(QOP_asqtad_coeffs_t *coeffs,
...
QOP_status_t QOP_F3_asqtad_invert(QOP_F3_FermionLinksAsqtad *asqtad,
				  QOP_invert_arg_t *inv_arg,
				  QOP_resid_arg_t *res_arg,
				  float mass,
				  QOP_F3_ColorVector *out_pt,
				  QOP_F3_ColorVector *in_pt);
QOP_status_t QOP_F3_asqtad_invert_multi(QOP_F3_FermionLinksAsqtad *asqtad,
					QOP_invert_arg_t *inv_arg,
					QOP_resid_arg_t **res_arg[],
...
QOP_status_t QOP_D3_asqtad_invert(QOP_D3_FermionLinksAsqtad *asqtad,
				  QOP_invert_arg_t *inv_arg,
				  QOP_resid_arg_t *res_arg,
				  double mass,
				  QOP_D3_ColorVector *out_pt,
				  QOP_D3_ColorVector *in_pt);
QOP_status_t QOP_D3_asqtad_invert_multi(QOP_D3_FermionLinksAsqtad *asqtad,
					QOP_invert_arg_t *inv_arg,
					QOP_resid_arg_t **res_arg[],
...
QOP_status_t QOP_F3_asqtad_force(QOP_F3_GaugeField *gauge,
				 QOP_F3_Force *force,
				 QOP_asqtad_coeffs_t *coeffs, float eps,
				 QOP_F3_ColorVector *in_pt);
QOP_status_t QOP_F3_asqtad_force_multi(QOP_F3_GaugeField *gauge,
				       QOP_F3_Force *force,
				       QOP_asqtad_coeffs_t *coef, float eps[],
				       QOP_F3_ColorVector *in_pt[], int nsrc);

QOP_status_t QOP_D3_asqtad_force(QOP_D3_GaugeField *gauge,
				 QOP_D3_Force *force,
				 QOP_asqtad_coeffs_t *coeffs, double eps,
				 QOP_D3_ColorVector *in_pt);
QOP_status_t QOP_D3_asqtad_force_multi(QOP_D3_GaugeField *gauge,
				       QOP_D3_Force *force,
				       QOP_asqtad_coeffs_t *coef, double eps[],
				       QOP_D3_ColorVector *in_pt[], int nsrc);
...
QOP_F3_FermionLinksWilson *
  QOP_F3_wilson_create_L_from_raw(float *links[], QOP_evenodd_t evenodd);
QOP_F3_FermionLinksWilson *
  QOP_F3_wilson_create_L_from_G(QOP_F3_GaugeField *gauge);

void QOP_F3_wilson_extract_L_to_raw(float *links[],
				    QOP_F3_FermionLinksWilson *src,
				    QOP_evenodd_t evenodd);
void QOP_F3_wilson_destroy_L(QOP_F3_FermionLinksWilson *field);

QOP_F3_FermionLinksWilson *
  QOP_F3_wilson_convert_L_from_raw(float *links[], QOP_evenodd_t evenodd);
float **QOP_F3_wilson_convert_L_to_raw(QOP_F3_FermionLinksWilson *src,
				       QOP_evenodd_t evenodd);
QOP_F3_FermionLinksWilson *
  QOP_F3_wilson_convert_L_from_G(QOP_F3_GaugeField *gauge);
QOP_F3_GaugeField *
  QOP_F3_wilson_convert_L_to_G(QOP_F3_FermionLinksWilson *links);

QOP_D3_FermionLinksWilson *
  QOP_D3_wilson_create_L_from_raw(double *links[], QOP_evenodd_t evenodd);
QOP_D3_FermionLinksWilson *
  QOP_D3_wilson_create_L_from_G(QOP_D3_GaugeField *gauge);

void QOP_D3_wilson_extract_L_to_raw(double *links[],
				    QOP_D3_FermionLinksWilson *src,
				    QOP_evenodd_t evenodd);
void QOP_D3_wilson_destroy_L(QOP_D3_FermionLinksWilson *field);

QOP_D3_FermionLinksWilson *
  QOP_D3_wilson_convert_L_from_raw(double *links[], QOP_evenodd_t evenodd);
double **QOP_D3_wilson_convert_L_to_raw(QOP_D3_FermionLinksWilson *src,
					QOP_evenodd_t evenodd);
QOP_D3_FermionLinksWilson *
  QOP_D3_wilson_convert_L_from_G(QOP_D3_GaugeField *gauge);
QOP_D3_GaugeField *
...
QOP_status_t QOP_F3_wilson_invert(QOP_F3_FermionLinksWilson *links,
				  QOP_invert_arg_t *inv_arg,
				  QOP_resid_arg_t *res_arg,
				  float kappa,
				  QOP_F3_DiracFermion *out_pt,
				  QOP_F3_DiracFermion *in_pt);
QOP_status_t QOP_F3_wilson_invert_multi(QOP_F3_FermionLinksWilson *links,
					QOP_invert_arg_t *inv_arg,
					QOP_resid_arg_t **res_arg[],
...
QOP_status_t QOP_D3_wilson_invert(QOP_D3_FermionLinksWilson *links,
				  QOP_invert_arg_t *inv_arg,
				  QOP_resid_arg_t *res_arg,
				  double kappa,
				  QOP_D3_DiracFermion *out_pt,
				  QOP_D3_DiracFermion *in_pt);
QOP_status_t QOP_D3_wilson_invert_multi(QOP_D3_FermionLinksWilson *links,
					QOP_invert_arg_t *inv_arg,
					QOP_resid_arg_t **res_arg[],
...
QOP_status_t QOP_F3_wilson_force(QOP_F3_GaugeField *gauge,
				 QOP_F3_Force *force,
				 QOP_wilson_coeffs_t *coeffs, float eps,
				 QOP_F3_ColorVector *in_pt);
QOP_status_t QOP_F3_wilson_force_multi(QOP_F3_GaugeField *gauge,
				       QOP_F3_Force *force,
				       QOP_wilson_coeffs_t *coef, float eps[],
				       QOP_F3_ColorVector *in_pt[], int nsrc);

QOP_status_t QOP_D3_wilson_force(QOP_D3_GaugeField *gauge,
				 QOP_D3_Force *force[],
				 QOP_wilson_coeffs_t *coeffs, double eps,
				 QOP_D3_ColorVector *in_pt);
QOP_status_t QOP_D3_wilson_force_multi(QOP_D3_GaugeField *gauge,
				       QOP_D3_Force *force,
				       QOP_wilson_coeffs_t *coef, double eps[],
				       QOP_D3_ColorVector *in_pt[], int nsrc);
...
QOP_F3_FermionLinksDW *
  QOP_F3_dw_create_L_from_G(QOP_F3_GaugeField *gauge);
...
float **QOP_F3_dw_convert_L_to_raw(QOP_F3_FermionLinksDW *src,
				       QOP_evenodd_t evenodd);
QOP_F3_FermionLinksDW *
  QOP_F3_dw_convert_L_from_G(QOP_F3_GaugeField *gauge);
QOP_F3_GaugeField *
...
QOP_D3_FermionLinksDW *
  QOP_D3_dw_create_L_from_G(QOP_D3_GaugeField *gauge);
...
double **QOP_D3_dw_convert_L_to_raw(QOP_D3_FermionLinksDW *src,
					QOP_evenodd_t evenodd);
QOP_D3_FermionLinksDW *
  QOP_D3_dw_convert_L_from_G(QOP_D3_GaugeField *gauge);
QOP_D3_GaugeField *
...
QOP_status_t QOP_F3_dw_invert(QOP_F3_FermionLinksDW *links,
			      QOP_invert_arg_t *inv_arg,
			      QOP_resid_arg_t *res_arg,
			      float m0,
			      float M,
			      ...
			      QOP_F3_DiracFermion *in_pt[],
			      int Ls);
QOP_status_t QOP_F3_dw_invert_multi(QOP_F3_FermionLinksDW *links,
				    QOP_invert_arg_t *inv_arg,
				    QOP_resid_arg_t **res_arg[],
				    float *m0[],
				    float *M[],
...
QOP_status_t QOP_D3_dw_invert(QOP_D3_FermionLinksDW *links,
			      QOP_invert_arg_t *inv_arg,
			      QOP_resid_arg_t *res_arg,
			      double m0,
			      double M,
			      ...
			      QOP_D3_DiracFermion *in_pt[],
			      int Ls);
QOP_status_t QOP_D3_dw_invert_multi(QOP_D3_FermionLinksDW *links,
				    QOP_invert_arg_t *inv_arg,
				    QOP_resid_arg_t **res_arg[],
				    double *m0[],
				    double *M[],
...
QOP_status_t QOP_F3_dw_force(QOP_F3_GaugeField *gauge,
				 QOP_F3_Force *force,
				 QOP_dw_coeffs_t *coeffs, float eps,
				 QOP_F3_ColorVector *in_pt);
QOP_status_t QOP_F3_dw_force_multi(QOP_F3_GaugeField *gauge,
				       QOP_F3_Force *force,
				       QOP_dw_coeffs_t *coef, float eps[],
				       QOP_F3_ColorVector *in_pt[], int nsrc);

QOP_status_t QOP_D3_dw_force(QOP_D3_GaugeField *gauge,
				 QOP_D3_Force *force[],
				 QOP_dw_coeffs_t *coeffs, double eps,
				 QOP_D3_ColorVector *in_pt);
QOP_status_t QOP_D3_dw_force_multi(QOP_D3_GaugeField *gauge,
				       QOP_D3_Force *force,
				       QOP_dw_coeffs_t *coef, double eps[],
				       QOP_D3_ColorVector *in_pt[], int nsrc);

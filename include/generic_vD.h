...
#define get_lattice_V(v)        QDP_get_lattice_D(v[0])
#define create_V(r)		{ r = malloc(_n*sizeof(Vector)); for(int _i=0; _i<_n; _i++) r[_i] = QDP_create_D_L(lat); }
...
#define c_veq_V_dot_V(r,a,b,s,n)  QOP_printf0("%s %i: unsupported\n", __FILE__, __LINE__);
...
#define V_meq_c_times_V(r,a,b,s)  { QLA_Complex _a[_n]; for(int _i=0; _i<_n; _i++) QLA_c_eq_c(_a[_i],*(a)); QDP_D_vmeq_c_times_D(r,_a,b,s,_n); }

...
void QOP_F1_extract_V_to_raw(QDP_Lattice *lat, QOP_F_Real *dest, QOP_F1_ColorVector *src, QOP_evenodd_t evenodd);
void QOP_F1_extract_D_to_raw(QDP_Lattice *lat, QOP_F_Real *dest, QOP_F1_DiracFermion *src, QOP_evenodd_t evenodd);
void QOP_F1_extract_G_to_raw(QDP_Lattice *lat, QOP_F_Real *dest[], QOP_F1_GaugeField *src, QOP_evenodd_t evenodd);
void QOP_F1_extract_F_to_raw(QDP_Lattice *lat, QOP_F_Real *dest[], QOP_F1_Force *src, QOP_evenodd_t evenodd);
...
QOP_F1_FermionLinksAsqtad *
  QOP_F1_asqtad_create_L_from_G2(QOP_info_t *info,
				 QOP_asqtad_coeffs_t *coeffs,
				 QOP_F1_GaugeField *gFat,
				 QOP_F1_GaugeField *gLong);
...
void QOP_F1_asqtad_load_L_from_G2(QOP_info_t *info,
				  QOP_F1_FermionLinksAsqtad *asqtad,
				  QOP_asqtad_coeffs_t *coeffs,
				  QOP_F1_GaugeField *gFat,
				  QOP_F1_GaugeField *gLong);
...
void QOP_F1_asqtad_ddagd(QOP_info_t *info,
			 QOP_F1_FermionLinksAsqtad *asqtad,
			 QOP_F_Real mass,
...
QOP_F_Real QOP_F1_asqtad_ddagd_norm2(QOP_info_t *info,
				     QOP_F1_FermionLinksAsqtad *asqtad,
				     QOP_F_Real mass,
				     QDP_F1_ColorVector *out,
				     QDP_F1_ColorVector *in,
...
void QOP_F1_asqtad_solve_multi_qdp(QOP_info_t *info,
				   QOP_F1_FermionLinksAsqtad *fla,
...
QOP_1_WilsonMg *QOP_1_wilsonMgNew(QDP_Lattice *lat);
...
void QOP_F1_wilsonMgSetLinks(QOP_1_WilsonMg *wmg, QOP_F1_FermionLinksWilson *wil);
void QOP_F1_wilsonMgSolve(QOP_info_t *info, QOP_1_WilsonMg *wmg,
			  QOP_F1_FermionLinksWilson *flw,

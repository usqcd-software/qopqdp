...
QOP_D2_ColorVector  *QOP_D2_create_V_from_raw( QDP_Lattice *lat, QOP_D_Real *src, QOP_evenodd_t evenodd);
QOP_D2_DiracFermion *QOP_D2_create_D_from_raw( QDP_Lattice *lat, QOP_D_Real *src, QOP_evenodd_t evenodd);
QOP_D2_GaugeField   *QOP_D2_create_G_from_raw( QDP_Lattice *lat, QOP_D_Real *links[], QOP_evenodd_t evenodd);
QOP_D2_Force        *QOP_D2_create_F_from_raw( QDP_Lattice *lat, QOP_D_Real *force[], QOP_evenodd_t evenodd);

/* copy QOP field into a raw field */
void QOP_D2_extract_V_to_raw(QDP_Lattice *lat, QOP_D_Real *dest, QOP_D2_ColorVector *src, QOP_evenodd_t evenodd);
void QOP_D2_extract_D_to_raw(QDP_Lattice *lat, QOP_D_Real *dest, QOP_D2_DiracFermion *src, QOP_evenodd_t evenodd);
void QOP_D2_extract_G_to_raw(QDP_Lattice *lat, QOP_D_Real *dest[], QOP_D2_GaugeField *src, QOP_evenodd_t evenodd);
void QOP_D2_extract_F_to_raw(QDP_Lattice *lat, QOP_D_Real *dest[], QOP_D2_Force *src, QOP_evenodd_t evenodd);
...
QOP_D2_ColorVector  *QOP_D2_convert_V_from_raw( QDP_Lattice *lat, QOP_D_Real *src, QOP_evenodd_t evenodd);
QOP_D2_DiracFermion *QOP_D2_convert_D_from_raw( QDP_Lattice *lat, QOP_D_Real *src, QOP_evenodd_t evenodd);
QOP_D2_GaugeField   *QOP_D2_convert_G_from_raw( QDP_Lattice *lat, QOP_D_Real *links[], QOP_evenodd_t evenodd);
QOP_D2_Force        *QOP_D2_convert_F_from_raw( QDP_Lattice *lat, QOP_D_Real *force[], QOP_evenodd_t evenodd);

/* create a raw field from the data in the QOP field and destroy it */
/* if the QOP field was created with a convert from raw function then
   this will return the same raw source used as input */
QOP_D_Real  *QOP_D2_convert_V_to_raw(QDP_Lattice *lat, QOP_D2_ColorVector *src, QOP_evenodd_t evenodd);
QOP_D_Real  *QOP_D2_convert_D_to_raw(QDP_Lattice *lat, QOP_D2_DiracFermion *src, QOP_evenodd_t evenodd);
QOP_D_Real **QOP_D2_convert_G_to_raw(QDP_Lattice *lat, QOP_D2_GaugeField *src, QOP_evenodd_t evenodd);
QOP_D_Real **QOP_D2_convert_F_to_raw(QDP_Lattice *lat, QOP_D2_Force *src, QOP_evenodd_t evenodd);
...
void QOP_D2_gauge_deriv_multi_qdp(QOP_info_t *info,
...
void QOP_D2_gauge_force_multi_qdp(QOP_info_t *info, QDP_D2_ColorMatrix *f[],
				  QOP_D2_GaugeField *g[],
				  QDP_D2_ColorMatrix **chain[], int n);
...
void QOP_D2_symanzik_1loop_gauge_action_qdp(QOP_info_t *info,
...
void QOP_D2_symanzik_1loop_gauge_heatbath_qdp(QOP_info_t *info,
					      QDP_D2_ColorMatrix *links[],
					      QLA_D_Real beta,
					      QOP_gauge_coeffs_t *coeffs,
					      QDP_RandomState *rs0,
...
void QOP_D2_symanzik_1loop_gauge_staple_qdp(QOP_info_t *info,
					    QDP_D2_ColorMatrix *links[],
					    QDP_D2_ColorMatrix *staple,
					    int mu,
					    QOP_gauge_coeffs_t *coeffs,
...
void QOP_D2_u3reunit(QOP_info_t *info, QDP_D2_ColorMatrix *U,
		     QDP_D2_ColorMatrix *V);

void QOP_D2_su3reunit(QOP_info_t *info, QDP_D2_ColorMatrix *U,
		      QDP_D2_ColorMatrix *Ur);
...
void QOP_D2_staples(QOP_info_t *info, int nout, int nin,
		    QDP_D2_ColorMatrix *out[], QDP_D2_ColorMatrix *in[],
		    int nstaples[], int *topdir[], int *sidedir[],
		    int *toplinknum[], int *sidelinknum[], QOP_D_Real *coef[]);

void QOP_D2_staples_deriv(QOP_info_t *info, int nout, int nin,
			  QDP_D2_ColorMatrix *deriv[],
			  QDP_D2_ColorMatrix *chain[],
			  QDP_D2_ColorMatrix *in[],
			  int nstaples[], int *topdir[], int *sidedir[],
...
QOP_D2_FermionLinksAsqtad *
  QOP_D2_asqtad_create_L_from_raw( QDP_Lattice *lat, 
                                  QOP_D_Real *fatlinks[],
...
QOP_D2_FermionLinksAsqtad *
  QOP_D2_asqtad_create_L_from_G2(QOP_info_t *info,
				 QOP_asqtad_coeffs_t *coeffs,
				 QOP_D2_GaugeField *gFat,
				 QOP_D2_GaugeField *gLong);

void QOP_D2_asqtad_extract_L_to_raw(QOP_D_Real *fatlinks[],
				    QOP_D_Real *longlinks[],
...
QOP_D2_FermionLinksAsqtad *
  QOP_D2_asqtad_convert_L_from_raw( QOP_D_Real *fatlinks[],
				   QOP_D_Real *longlinks[],
				   QOP_evenodd_t evenodd);

void QOP_D2_asqtad_convert_L_to_raw(QOP_D_Real ***fatlinks,
				    QOP_D_Real ***longlinks,
				    QOP_D2_FermionLinksAsqtad *,
				    QOP_evenodd_t evenodd);
...
void QOP_D2_asqtad_load_L_from_G2(QOP_info_t *info,
				  QOP_D2_FermionLinksAsqtad *asqtad,
				  QOP_asqtad_coeffs_t *coeffs,
				  QOP_D2_GaugeField *gFat,
				  QOP_D2_GaugeField *gLong);
...
QOP_D2_FermionLinksWilson *
  QOP_D2_wilson_create_L_from_raw( QDP_Lattice *lat, 
...
QOP_D2_FermionLinksWilson *
  QOP_D2_wilson_convert_L_from_raw( QOP_D_Real *links[],
				   QOP_D_Real *clov,
				   QOP_evenodd_t evenodd);
...
void QOP_D2_wilson_force_multi_qdp(QOP_info_t *info,
				   QOP_D2_FermionLinksWilson *flw,
				   QDP_D2_ColorMatrix *force[],
				   QOP_D_Real eps[],
				   QDP_D2_DiracFermion *x[],
...
QOP_2_WilsonMg *QOP_2_wilsonMgNew(QDP_Lattice *lat);
...
QOP_D2_FermionLinksDW *
  QOP_D2_dw_create_L_from_raw( QDP_Lattice *lat, 
                              QOP_D_Real *links[],
			      QOP_evenodd_t evenodd);
...
QOP_D2_FermionLinksDW *
  QOP_D2_dw_convert_L_from_raw( QOP_D_Real *links[],
			       QOP_evenodd_t evenodd);

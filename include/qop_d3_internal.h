...
struct QOP_3_WilsonMgStruct {
  ...
  QOP_F3_FermionLinksWilson *wilF_priv;
...
void * create_qll_gaugeD3(int nc);
void * create_qll_from_gaugeD3(QDP_ColorMatrix *g[]);
void copy_gauge_from_qllD3(QDP_ColorMatrix *g[], void *ff);
void free_qll_gaugeD3(void *ff);
void fat7_qllD3(void *qllfl, void *qllll, QOP_asqtad_coeffs_t *coef,
...
void setup_quda_solverD3(QOP_FermionLinksAsqtad *fla);
void free_quda_solverD3(void);
void solve_qudaD3(QDP_ColorVector *dest, QDP_ColorVector *src, double mass,
		     QOP_invert_arg_t *invarg, QOP_resid_arg_t *resarg,
		     QOP_evenodd_t eo);
void solveMulti_qudaD3(QDP_ColorVector *dest[], QDP_ColorVector *src,
			  double ms[], int nm,  QOP_invert_arg_t *invarg,
			  QOP_resid_arg_t *resargs[]);

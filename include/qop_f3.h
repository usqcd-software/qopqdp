...
QOP_F3_ColorVector  *QOP_F3_create_V_from_raw( QDP_Lattice *lat, QOP_F_Real *src, QOP_evenodd_t evenodd);
QOP_F3_DiracFermion *QOP_F3_create_D_from_raw( QDP_Lattice *lat, QOP_F_Real *src, QOP_evenodd_t evenodd);
QOP_F3_GaugeField   *QOP_F3_create_G_from_raw( QDP_Lattice *lat, QOP_F_Real *links[], QOP_evenodd_t evenodd);
...
QOP_F3_ColorVector  *QOP_F3_convert_V_from_raw( QDP_Lattice *lat, QOP_F_Real *src, QOP_evenodd_t evenodd);
QOP_F3_DiracFermion *QOP_F3_convert_D_from_raw( QDP_Lattice *lat, QOP_F_Real *src, QOP_evenodd_t evenodd);
QOP_F3_GaugeField   *QOP_F3_convert_G_from_raw( QDP_Lattice *lat, QOP_F_Real *links[], QOP_evenodd_t evenodd);
QOP_F3_Force        *QOP_F3_convert_F_from_raw( QDP_Lattice *lat, QOP_F_Real *force[], QOP_evenodd_t evenodd);

/* create a raw field from the data in the QOP field and destroy it */
/* if the QOP field was created with a convert from raw function then
   this will return the same raw source used as input */
QOP_F_Real  *QOP_F3_convert_V_to_raw(QDP_Lattice *lat, QOP_F3_ColorVector *src, QOP_evenodd_t evenodd);
QOP_F_Real  *QOP_F3_convert_D_to_raw(QDP_Lattice *lat, QOP_F3_DiracFermion *src, QOP_evenodd_t evenodd);
QOP_F_Real **QOP_F3_convert_G_to_raw(QDP_Lattice *lat, QOP_F3_GaugeField *src, QOP_evenodd_t evenodd);
QOP_F_Real **QOP_F3_convert_F_to_raw(QDP_Lattice *lat, QOP_F3_Force *src, QOP_evenodd_t evenodd);
...
void QOP_F3_rephase_G_qdp(QDP_F3_ColorMatrix *links[],
			  int *r0,
			  QOP_bc_t *bc,
			  QOP_staggered_sign_t *sign);

void QOP_F3_smear_fat7l_qdp(QOP_info_t *info, QDP_F3_ColorMatrix *sg[],
			    QDP_F3_ColorMatrix *g[],
			    QOP_asqtad_coeffs_t *coeffs);

void QOP_F3_gauge_deriv_multi_qdp(QOP_info_t *info,
				  QDP_F3_ColorMatrix *deriv[],
				  QOP_F3_GaugeField *g[],
				  QDP_F3_ColorMatrix **chain[],
				  int n, int doLastScale);

void QOP_F3_gauge_force_multi_qdp(QOP_info_t *info, QDP_F3_ColorMatrix *f[],
				  QOP_F3_GaugeField *g[],
				  QDP_F3_ColorMatrix **chain[], int n);
...
void QOP_F3_symanzik_1loop_gauge_action_qdp(QOP_info_t *info,
...
void QOP_F3_symanzik_1loop_gauge_force_qdp(QOP_info_t *info, 
					   QDP_F3_ColorMatrix *links[],
					   QDP_F3_ColorMatrix *force[],
					   QOP_gauge_coeffs_t *coeffs,
					   QOP_F_Real eps);

void QOP_F3_symanzik_1loop_gauge_deriv_qdp(QOP_info_t *info,
					   QDP_F3_ColorMatrix *links[],
					   QDP_F3_ColorMatrix *deriv[],
					   QOP_gauge_coeffs_t *coeffs,
					   QOP_F_Real eps, int doLastScale);

void QOP_F3_symanzik_1loop_gauge_heatbath_qdp(QOP_info_t *info,
					      QDP_F3_ColorMatrix *links[],
					      QLA_F_Real beta,
					      QOP_gauge_coeffs_t *coeffs,
					      QDP_RandomState *rs0,
...
void QOP_F3_symanzik_1loop_gauge_staple_qdp(QOP_info_t *info,
					    QDP_F3_ColorMatrix *links[],
					    QDP_F3_ColorMatrix *staple,
					    int mu,
					    QOP_gauge_coeffs_t *coeffs,
					    QDP_Subset subs[], int subi);

void QOP_F3_projectU_qdp(QOP_info_t *info,
			 QDP_F3_ColorMatrix *pU,
			 QDP_F3_ColorMatrix *U);

void QOP_F3_projectU_deriv_qdp(QOP_info_t *info,
			       QDP_F3_ColorMatrix *f,
			       QDP_F3_ColorMatrix *pU,
			       QDP_F3_ColorMatrix *U,
			       QDP_F3_ColorMatrix *chain);

void QOP_F3_u3reunit(QOP_info_t *info, QDP_F3_ColorMatrix *U,
		     QDP_F3_ColorMatrix *V);

void QOP_F3_su3reunit(QOP_info_t *info, QDP_F3_ColorMatrix *U,
		      QDP_F3_ColorMatrix *Ur);

void QOP_F3_hisq_force_multi_reunit(QOP_info_t *info,
				    QDP_F3_ColorMatrix *gf[4],
				    QDP_F3_ColorMatrix *force_accum[4],
				    QDP_F3_ColorMatrix *force_accum_old[4]);

void QOP_F3_staples(QOP_info_t *info, int nout, int nin,
		    QDP_F3_ColorMatrix *out[], QDP_F3_ColorMatrix *in[],
		    int nstaples[], int *topdir[], int *sidedir[],
		    int *toplinknum[], int *sidelinknum[], QOP_F_Real *coef[]);

void QOP_F3_staples_deriv(QOP_info_t *info, int nout, int nin,
			  QDP_F3_ColorMatrix *deriv[],
			  QDP_F3_ColorMatrix *chain[],
			  QDP_F3_ColorMatrix *in[],
			  int nstaples[], int *topdir[], int *sidedir[],
...
QOP_F3_FermionLinksAsqtad *
  QOP_F3_asqtad_create_L_from_raw( QDP_Lattice *lat, 
                                  QOP_F_Real *fatlinks[],
...
QOP_F3_FermionLinksAsqtad *
  QOP_F3_asqtad_create_L_from_G2(QOP_info_t *info,
				 QOP_asqtad_coeffs_t *coeffs,
				 QOP_F3_GaugeField *gFat,
				 QOP_F3_GaugeField *gLong);

void QOP_F3_asqtad_extract_L_to_raw(QOP_F_Real *fatlinks[],
				    QOP_F_Real *longlinks[],
...
QOP_F3_FermionLinksAsqtad *
  QOP_F3_asqtad_convert_L_from_raw( QOP_F_Real *fatlinks[],
				   QOP_F_Real *longlinks[],
				   QOP_evenodd_t evenodd);

void QOP_F3_asqtad_convert_L_to_raw(QOP_F_Real ***fatlinks,
				    QOP_F_Real ***longlinks,
				    QOP_F3_FermionLinksAsqtad *,
				    QOP_evenodd_t evenodd);
...
void QOP_F3_asqtad_load_L_from_G2(QOP_info_t *info,
				  QOP_F3_FermionLinksAsqtad *asqtad,
				  QOP_asqtad_coeffs_t *coeffs,
				  QOP_F3_GaugeField *gFat,
				  QOP_F3_GaugeField *gLong);
...
void QOP_F3_asqtad_ddagd(QOP_info_t *info,
			 QOP_F3_FermionLinksAsqtad *asqtad,
			 QOP_F_Real mass,
...
QOP_F_Real QOP_F3_asqtad_ddagd_norm2(QOP_info_t *info,
				     QOP_F3_FermionLinksAsqtad *asqtad,
				     QOP_F_Real mass,
				     QDP_F3_ColorVector *out,
				     QDP_F3_ColorVector *in,
...
void QOP_F3_asqtad_solve_multi_qdp(QOP_info_t *info,
...
void QOP_F3_asqtad_deriv(QOP_info_t *info, QDP_F3_ColorMatrix *gauge[],
			 ...
			 QDP_F3_ColorMatrix *mid_fat[],
			 QDP_F3_ColorMatrix *mid_naik[]);
...
void QOP_F3_asqtad_deriv_multi_qdp(QOP_info_t *info,
				   QDP_F3_ColorMatrix *links[],
				   QDP_F3_ColorMatrix *force[],
				   QOP_asqtad_coeffs_t *coef,
				   QOP_F_Real eps[],
...
QOP_F3_FermionLinksWilson *
  QOP_F3_wilson_create_L_from_raw( QDP_Lattice *lat, 
...
QOP_F3_FermionLinksWilson *
  QOP_F3_wilson_convert_L_from_raw( QOP_F_Real *links[],
				   QOP_F_Real *clov,
				   QOP_evenodd_t evenodd);
...
void QOP_F3_wilson_deriv_multi_qdp(QOP_info_t *info,
				   QOP_F3_FermionLinksWilson *flw,
				   QDP_F3_ColorMatrix *deriv[],
				   QOP_F_Real eps[],
...
void QOP_F3_wilson_force_multi_qdp(QOP_info_t *info,
				   QOP_F3_FermionLinksWilson *flw,
				   QDP_F3_ColorMatrix *force[],
				   QOP_F_Real eps[],
				   QDP_F3_DiracFermion *x[],
...
void QOP_F3_wilson_deriv_prec_multi_qdp(QOP_info_t *info,
					QOP_F3_FermionLinksWilson *flw,
					QDP_F3_ColorMatrix *deriv[],
					QOP_F_Real kappa[],
					QOP_F_Real eps[],
...
void QOP_F3_wilson_ifla_dslash(QOP_info_t *info,
			       QOP_F3_FermionLinksWilson *flw,
			       QOP_F_Real kappa,
			       int sign,
...
void QOP_F3_wilson_ifla_dslash_qdp(QOP_info_t *info,
				   QOP_F3_FermionLinksWilson *flw,
				   QOP_F_Real kappa,
				   int sign,
				   QOP_wilson_ifla_coeffs_t *coeffs,
...
QOP_3_WilsonMg *QOP_3_wilsonMgNew(QDP_Lattice *lat);
...
void QOP_F3_wilsonMgSetLinks(QOP_3_WilsonMg *wmg, QOP_F3_FermionLinksWilson *wil);
void QOP_F3_wilsonMgSolve(QOP_info_t *info, QOP_3_WilsonMg *wmg,
			  QOP_F3_FermionLinksWilson *flw,
...
QOP_F3_FermionLinksDW *
  QOP_F3_dw_create_L_from_raw( QDP_Lattice *lat, 
                              QOP_F_Real *links[],
			      QOP_evenodd_t evenodd);
...
QOP_F3_FermionLinksDW *
  QOP_F3_dw_convert_L_from_raw( QOP_F_Real *links[],
			       QOP_evenodd_t evenodd);
...
void QOP_F3_dw_dslash2(QOP_info_t *info,
		       QOP_F3_FermionLinksDW *links,
		       QOP_F_Real M5,
		       QOP_F_Real m,
		       QOP_F3_DiracFermion *out_pt[],

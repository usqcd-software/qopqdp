...
//#define V_peq_V(r,a) QDPN(V_vpeq_V)(r,a,sub,nv)
//#define V_meq_V(r,a) QDPN(V_vmeq_V)(r,a,sub,nv)
...
#define r_eq_norm2_V(r,a) { QLA_Real _r[nv]; QDPN(r_veq_norm2_V)(_r,a,sub,nv); *(r) = 0; for(int _i=0; _i<nv; _i++) {*(r) += _r[_i];} }
//#define r_eq_norm2_V(r,a) { QLA_Real _r[nv]; QDPN(r_veq_norm2_V)(_r,a,sub,nv); *(r) = 0; for(int _i=0; _i<nv; _i++) {if(!(_r[_i]>0))printf0("%s %i %g\n",__func__,__LINE__,_r[_i]); *(r) += _r[_i];} }
//#define r_eq_norm2_V(r,a) { QLA_Real _r; *(r) = 0; for(int _i=0; _i<nv; _i++) { QDPN(r_eq_norm2_V)(&_r,(a)[_i],sub); *(r) += _r; } }

#define r_eq_re_V_dot_V(r,a,b) { QLA_Real _r[nv]; QDPN(r_veq_re_V_dot_V)(_r,a,b,sub,nv); *(r) = 0; for(int _i=0; _i<nv; _i++) {*(r) += _r[_i];} }
...
//#define V_eq_r_times_V(r,a,b) { QLA_Real _a[nv]; for(int _i=0; _i<nv; _i++) _a[_i] = *(a); QDPN(V_veq_r_times_V)(r,_a,b,sub,nv); }
//#define V_peq_r_times_V(r,a,b) { QLA_Real _a[nv]; for(int _i=0; _i<nv; _i++) _a[_i] = *(a); QDPN(V_vpeq_r_times_V)(r,_a,b,sub,nv); }
//#define V_meq_r_times_V(r,a,b) { QLA_Real _a[nv]; for(int _i=0; _i<nv; _i++) _a[_i] = *(a); QDPN(V_vmeq_r_times_V)(r,_a,b,sub,nv); }
#define V_eq_r_times_V(r,a,b) { QLA_Real _a = *(a); for(int _i=0; _i<nv; _i++) QDPN(V_eq_r_times_V)((r)[_i],&_a,(b)[_i],sub); }
#define V_peq_r_times_V(r,a,b) { QLA_Real _a = *(a); for(int _i=0; _i<nv; _i++) QDPN(V_peq_r_times_V)((r)[_i],&_a,(b)[_i],sub); }
#define V_meq_r_times_V(r,a,b) { QLA_Real _a = *(a); for(int _i=0; _i<nv; _i++) QDPN(V_meq_r_times_V)((r)[_i],&_a,(b)[_i],sub); }
...
#define V_eq_c_times_V(r,a,b) { QLA_Complex _a; QLA_c_eq_c(_a,*(a)); for(int _i=0; _i<nv; _i++) QDPN(V_eq_c_times_V)((r)[_i],&_a,(b)[_i],sub); }
#define V_peq_c_times_V(r,a,b) { QLA_Complex _a; QLA_c_eq_c(_a,*(a)); for(int _i=0; _i<nv; _i++) QDPN(V_peq_c_times_V)((r)[_i],&_a,(b)[_i],sub); }
#define V_meq_c_times_V(r,a,b) { QLA_Complex _a; QLA_c_eq_c(_a,*(a)); for(int _i=0; _i<nv; _i++) QDPN(V_meq_c_times_V)((r)[_i],&_a,(b)[_i],sub); }

//#define V_eq_V_plus_V(r,a,b) QDPN(V_veq_V_plus_V)(r,a,b,sub,nv)
//#define V_eq_V_minus_V(r,a,b) QDPN(V_veq_V_minus_V)(r,a,b,sub,nv)
